/* SETTINGS START */
const prefix = "!"
const groupID = 3336473;
const bot_token = process.env.botToken;
const rblxCookie = process.env.rblxCookie;
const officerRoleE = "XPGiver";
const welcomeMessage = "Welcome!";
const maxXP = 550;
const xpAuditLogChannelID = "656620530828574730";
const mainChatChannelID = "504811487609618452";
...
const groupID = 3336473;
const bot_token = process.env.botToken;
const rblxCookie = process.env.rblxCookie;/* SETTINGS START */
const prefix = "!"
const groupID = 3336473;
const bot_token = process.env.botToken;
const rblxCookie = process.env.rblxCookie;
...
const rbx = require('noblox.js');
const bloxy = require('bloxy');
const bloxy = require("bloxy");/* SETTINGS START */
const prefix = "!"
const groupID = 3336473;
const bot_token = process.env.botToken;
const rblxCookie = process.env.rblxCookie;
...
bot.login(bot_token)
  ...
  await bloxyClient.login({
    cookie: `${}`
  }).catch(err => console.log("Looks like I am not logging in"));/* SETTINGS START */
const prefix = "!"
const groupID = 3336473;
const bot_token = process.env.botToken;
const rblxCookie = process.env.rblxCookie;
